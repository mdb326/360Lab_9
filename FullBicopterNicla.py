...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppyaw", 0.11) #2
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "yawrate_gamma", 0.9)
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "z_int_low", 0.3)
    serial.send_preference(ROBOT_MAC, DataType_Float, "z_int_high", 0.39)
